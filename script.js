const projects = [
  { href: "https://pdf-page-organizer.netlify.app/", img: "images/pdf-organizer.png", alt: "PDF Organizer"},
  { href: "https://ai-podcast-generator-production.up.railway.app/", img: "images/ai-podcast-generator.png", alt: "AI Podcast Generator" },
  { href: "https://ai-text-summarizer-production-161d.up.railway.app/", img: "images/ai-text-summarizer.png", alt: "AI Text Summarizer" },
  { href: "https://chat-app-production-a703.up.railway.app/login", img: "images/chat-app.png", alt: "Chat App" },
  ...
  { href: "https://inventory-app-production-fe9a.up.railway.app/games", img: "images/inventory-logo.png", alt: "Inventory" },
